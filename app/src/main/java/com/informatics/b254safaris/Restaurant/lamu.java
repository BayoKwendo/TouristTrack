package com.informatics.b254safaris.Restaurant;
...
public class lamu extends AppCompatActivity {
...
//		Log.e("TopicsActivity","" + bookKey);
		...
		Hotels = FirebaseDatabase.getInstance().getReference().child("Restaurant");
	...
	private void loadData() {
        ...
        Query query = Hotels.orderByChild("Town").equalTo("Lamu");
...
//                });
                    ...
                    holder.mView.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            Intent topicsIntent = new Intent(lamu.this, DetailActivity.class);
